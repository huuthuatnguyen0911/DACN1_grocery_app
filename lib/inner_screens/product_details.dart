...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    String formattedPrice = formatCurrency.format(getCurrProduct.price);
    String formattedTotalPrice = formatCurrency.format(totalPrice);
    formattedusedPrice = formattedusedPrice.replaceAll(RegExp(r'\s+'), '');
    formattedPrice = formattedPrice.replaceAll(RegExp(r'\s+'), '');
    formattedTotalPrice = formattedTotalPrice.replaceAll(RegExp(r'\s+'), '');
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          TextWidget(
                            text: getCurrProduct.isPiece ? 'Cái' : '/kg',
                            color: Colors.green,
                            textSize: 12,
                            isTitle: false,
                          ),
